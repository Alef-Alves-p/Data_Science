...
def generate_random_data(num_rows):
    ...
    professions = ["Engenheiro", "Professor", "Médico", "Escritor", "Artista", "Programador", "Enfermeiro", "Advogado", 
                   "Cozinheiro", "Cientista", "Atleta", "Músico", "Piloto", "Designer", "Psicólogo", "Arquiteto",
                   "Jornalista", "Empresário", "Farmacêutico", "Policial", "Bombeiro", "Veterinário", "Motorista", "Estudante", 
                   "Garçom", "Eletricista", "Dentista", "Vendedor", "Padeiro"]
